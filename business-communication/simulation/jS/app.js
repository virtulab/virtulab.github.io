...
// LO1 - Keyur
var showForm = false;
var mainBtnClicked = false;
var squrecontainerfp = [];
var changecolor = false;
var Q2condition = false;
var Q3condition = false;
var Q4condition = false;
var Q5condition = false;
var nextbtn = false;
var QTotalAnswer = 0;
var correctAnswer = 0;
var score = 0;
...
function Level1() {
    ...
    var btnct = [];
    var btnctnext = [];
    function countresult(correctAnswer, question) {
        if (question == 1) {
    ...
    function ButtonQ1(btnsp, txtsp, txt) {
    ...
    function ButtonQ2(btnsp, txtsp, txt) {
        let btn1 = new Geometry.Button(context, new Geometry.Point(btnsp.x, btnsp.y), 32, 90, 8);
        btn1.draw();
        btnct.push(btn1);
        context.font = "bold 13px Arial, sans-serif";
    ...
    function ButtonQ3(btnsp, txtsp, txt) {
    ...
    function ButtonQ4(btnsp, txtsp, txt) {
    ...
    function ButtonQ5(btnsp, txtsp, txt) {
    ...
    function endScreen(marks) {
        ...
        if (score == 8 || score == 12) {
            ...
            let gt = "You have marked " + correctAnswer + " correct\nanswers out of " + TotalResponse + " responses.\nYour understanding is Good!";
            formatQue(gt, 435, 82);
        }
        else {
            //EllipseClickEvent = false;
            ...
            let st = "You have marked " + correctAnswer + " correct\nanswers out of " + TotalResponse + " responses.\nYour understanding is Satisfactory!";
            formatQue(st, 435, 82);
        }
        ButtonQ1(new Geometry.Point(355, 530), new Geometry.Point(400, 550), "NEXT");
        correctAnswer = 0;
