namespace Geometry_shubham
{
    ...
    export class Closepath
    {
        ...
        constructor(context:CanvasRenderingContext2D,arrapoint:Point[],color?:string)
        {
        ...
        draw(str1:string,str2:string,str3:string,str4:string,str5:string,str6:string)
        {
            var i:number;
    ...
    export class Ellipse extends Closepath
    {
        public a:number;
        public b:number;
        constructor(context:CanvasRenderingContext2D,pt:Point,majorx:number,minory:number,color?:string)
        {
            if(color==undefined)
            super(context,[]);
            else
    ...
    export class Bubble3
    {
        ...
        private op4pt:Point;
        public str:Data3;
        public bubblecontainer:Geometry_shubham.Ellipse[]=[];
    ...
    export class Ractangle
    {
        ...
        public data:string[];
        constructor(p:Point,data:string[],length:number,hight:number,context:CanvasRenderingContext2D,)
        {
            this.context=context;
            this.st_pt=p;
            this.color="blue";
    ...
    export class Box 
    {
        private context:CanvasRenderingContext2D;
        public rpt:Point[]=[];
        public rqcontainer:Ractangle[]=[];
        private b1:Ractangle;
        private b2:Ractangle;
        private b3:Ractangle;
        private b4:Ractangle;
        public d2:Data2;
        constructor(contex:CanvasRenderingContext2D,num:number)
        {
            this.context=context;
    ...
    export class Img1
    {
        ...
        constructor(img:CanvasImageSource,context: CanvasRenderingContext2D,pt:Point,w:number,h:number) 
        {
            this.img1=img;
            this.context = context;
            this.st_pt=pt;
    ...
    export class Img_Container
    {
        public st_pt:Point;
        public width:number;
        public height:number;
        
        constructor(pt:Point,w:number,h:number)
        {
            this.st_pt=pt;
            this.width=w;
            this.height=h;
    ...
    {
        private context:CanvasRenderingContext2D;
        public img_container:Img_Container[]=[];
        private temp:Img_Container;
        public ans:number[]=[];
        private aud=new Audio();
        constructor(context: CanvasRenderingContext2D) 
        {
            this.context = context;
        }
