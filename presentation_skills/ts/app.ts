...
var squrecontainerfp: Geometry.Rectangle[] = [];
...
function rectclickps(e: MouseEvent) {   //For selecting main screen user options
...
function PS() {   //Code of Public Speaking Section
    var EllipseClickEvent: boolean = true;
    var btnClickEvent: boolean = false;
    var TotalScore: number = 0;
    
    function drawVinod() {   //Drawing the host (Vidhya)
        let i1 = new Geometry.Img(context);
        i1.draw('images/host1.png', 645, 328, 96, 230);
    }     

    function drawRavi() {    //Drawing the host (Ravina)
        let imgRavi = new Geometry.Img(context);
        imgRavi.draw('images/host2.png', 645, 328, 96, 230);
    }     
    
    function drawAud() {   //Drawing the audience for Q1-Q5
    ...
    function drawSim2() {   //Drawing the simulation for Q6-Q10
    ...
    function rightAns() {   //To be triggered when user gives the right answer
        ellipscontainer = [];
    ...
    function wrongAns() {   //To be triggered when user gives the wrong answer
        ellipscontainer = [];
        Level2ellipscontainer = [];
        btnct = [];
        q15container = [];
    ...
    function rightAnsImg() {   //To be triggered when user selects the right image
        squrecontainer = [];
        squrecontainer2 = [];
    ...
    function wrongAnsImg() {   //To be triggered when user selects the wrong image
        squrecontainer = [];
        squrecontainer2 = [];
    ...
    function drawSB1(){   //Drawing a speech bubble
    ...
    function q21DrawImg() {   //Drawing an image
    ...
    function Thankyou() {   //Function for gratitude at the end
    ...
    var Level2ellipscontainer: Geometry.ClosePathProperty[] = [];
    
    /*Level 2 Ellips Click Event */ 
    canvas.addEventListener("click", Level2ellipseclick, false); 
    function Level2ellipseclick(e: MouseEvent) {   
        let x = e.clientX - ract.x;
        let y = e.clientY - ract.y; 
        let p1 = new Geometry.Point(x, y); 
                    ...
                    if(TotalQuestion <= 17){
                        ...
                        if(TotalQuestion == 14){ 
                            ...
                            let q14op3 = setTimeout(function() {
                                ...
                                l2DrawSB3();
                                let s: string = "I will prepare properly\nthree days in advance\nwith an outline to\nrecall the main points";
                                formatOpt(s, 451, 488);
                            }, 1000*1)
                            setTimeout(clearScreen, 1000*4.9);
                        }
                            ...
                            let q15op4 = setTimeout(function() {
                                ...
                                l2DrawSB4();
                                let s: string = "It's lack of arousing\nand sustaining the\ninterest of the\naudience";
                                formatOpt(s, 451, 82);
                            }, 1000*1)
                            setTimeout(clearScreen, 1000*4.9);
                        }
    ...
    function l2DrawSB1() {   //Drawing a speech bubble
        Level2ellipscontainer = [];
    ...
    var q15container: Geometry.ClosePathProperty[] = [];
    
    function q15eclick(e: MouseEvent) {   
        let x = e.clientX - ract.x;
        let y = e.clientY - ract.y; 
        let p1 = new Geometry.Point(x, y);  
                        ...
                        if(TotalQuestion <= 28){
                            ...
                            if(TotalQuestion == 18){ 
                                ...
                                let c2q2op4 = setTimeout(function() {
                                    q24DrawImg();
                                    q15DrawSB4();
                                    let s: string = "I will say that it\nwill be covered later\nto avoid her at that\npoint of time";
                                    formatOpt(s, 532, 482);
                                }, 1000*1)
                                setTimeout(clearScreen, 1000*4.9);
                            }
                                ...
                                let c2q3op4 = setTimeout(function() {
                                    q24DrawImg();
                                    q15DrawSB4();
                                    let s: string = "She should answer\nthe question and say\nthat she will show\nthe slide later ";
                                    formatOpt(s, 532, 484);
                                ...
                                let c2q5op3 = setTimeout(function() {
                                    q24DrawImg();
                                    q15DrawSB3();
                                    let s1: string = "No as she\ncould have told\nthat she will clarify\nthe doubts later\nat the end of\nthe session";
                                    formatOpt(s1, 382, 467);
                                    q15DrawSB2();
                                    let s2: string = "No as she did\nnot get a chance\nto complete her\nspeech with all\nthe points";
    ...
    function q15DrawSB1(){   //Drawing a speech bubble
    ...
    function CSLabel(startx: number) {   //Display Case Study label
    ...
    function GetResult(correct: number) {   //Evaluating the result
        score = correct * 3;
        TotalScore += score;
    }
    
    function GetResult1(correct: number) {
        score = correct * 4;
        TotalScore += score;
    }
    
    function GetResult2(correct: number) {
        score = correct * 5;
        TotalScore += score;
    }
    
    function GetResult3(correct: number) {
        score = correct * 6;
        TotalScore += score;
    }
    ...
    var QuestionArray: Array<number> = [1];
    var QuestionNum: number;
    
    function ellipseclick(e: MouseEvent) {   
        let x = e.clientX - ract.x;
        let y = e.clientY - ract.y; 
        let p1 = new Geometry.Point(x, y); 
    ...
    function Buttonl2(btnsp: Geometry.Point, txtsp: Geometry.Point, txt: string) {
    ...
    function Questions() {   //Function for asking the questions
        ...
        if(TotalQuestion == 5) {
            ...
            let q1 = setTimeout(function() {
                drawSQ1();
                s21q1.play();
                let s: string = "Hello! I am your host\nVidhya. I will guide\nyou through this\ninteractive session\non Public Speaking.\nSo, What is the\ndifference between\npublic speaking\nand elocution?";
                formatQue(s, 710, 79);
                EllipseClickEvent = false;
            }, 1000*0.5)
            ...
            let q2op3 = setTimeout(function() {
                drawSB3();
                let s: string = "Language,\nAccent, Style,\nPronunciation,\nInformation are\nof prime importance";
                formatOpt(s, 120, 240);
            }, 1000*11)
            
            let q2op4 = setTimeout(function() {
                drawSB4();
                let s: string = "I feel the factors\nlike Audience,\nDelivery,\nVocal qualities,\nPosture, pronunciation\nare important";
                formatOpt(s, 123, 404);  
            }, 1000*11.5)
            ...
            let q3op1 = setTimeout(function() {
                drawSB1();
                let s: string = "I want to\ninform,\nmake people\nlaugh\n& have fun";
                formatOpt(s, 516, 239);
            }, 1000*6)
            
            let q3op2 = setTimeout(function() {
                drawSB2();
                let s: string = "I give speeches\nto persuade,\nact & adjust\nmy speaking\nstyle";
                formatOpt(s, 322, 142);
            }, 1000*6.5)
            ...
            let q5op1 = setTimeout(function() {
                drawSB1();
                let s: string = "I will Talk about\na subject with which\n I have had some\npersonal experience\nthat I can share\n in my speech";
                formatOpt(s, 516, 234);
            }, 1000*4)
            ...
            let q9 = setTimeout(function() {
                drawSim2();
                s22q6.play();
                let q6: string = "Hello! I am Raveena.\nLet us see how\nprepared you are\nfor public speaking!\nSo, Identify the\nappropriate posture\nfor presentation.";
                formatQue(q6, 710, 96);
            }, 1000*0.1)
            ...
            let q13 = setTimeout(function() {
                drawSim2();
                s22q10.play();
                let q10: string = "Identify the HIGH\npower pose\nbody language\npreferred before\npublic speech?";
            ...
            let q14 = setTimeout(function() {
                drawSQ1();
                s23q1.play();
                let s: string = "You are a BE student\npreparing a project\nand you have been\nasked to address\nyour juniors. What\noptions would you\nchoose first?";
                formatQue(s, 710, 97);
                EllipseClickEvent = false;
            }, 1000*0.5)
            ...
            let q15 = setTimeout(function() {
                drawSQ1();
                s23q2.play();
                let s: string = "In the professional\nworld, a number\nof speeches are\ndelivered everyday.\nHowever, most of\nthe speeches are\nforgotten. Why?";
                formatQue(s, 710, 97);
                EllipseClickEvent = false;
            }, 1000*0.5)
            ...
            let q15op1 = setTimeout(function() {
                ...
                l2DrawSB1();
                let s: string = "As I feel there is\nLack of Information";
                formatOpt(s, 169, 502);
            }, 1000*11)
            ...
            let q17 = setTimeout(function() {
                drawSQ1();
                s23q4.play();
                let s: string = "Immediately after\nan opener, what\nwill be your way\nto start off the\npresentation?";
                formatQue(s, 710, 114);
                EllipseClickEvent = false;
            }, 1000*0.5)
            ...
            let q17op1 = setTimeout(function() {
                ...
                e1.draw();
                Level2ellipscontainer.push(new Geometry.ClosePathProperty(e1));
                let s: string = "I will Start with\nthe introduction";
                formatOpt(s, 169, 402);
            }, 1000*7)
            ...
            let q17op2 = setTimeout(function() {
                ...
                e2.draw();
                Level2ellipscontainer.push(new Geometry.ClosePathProperty(e2));
                let s: string = "I will start by a\ndetailed analysis of\nthe main points";
                formatOpt(s, 169, 188);
            }, 1000*7.5)
            ...
            let c1qu1 = setTimeout(function() {
                ...
                t4.draw();
                s24qu1.play();
                let s: string = "One suggestion was\nnot to look at such\na big audience as\nit may scare Ravi.";
                formatOpt(s, 106, 80);  
            }, 1000*24.9)
            ...
            let c1q2op2 = setTimeout(function() {
                q15DrawSB2();
                let s: string = "Excerpt 2\nis what I think\nis correct";
                formatOpt(s, 232, 490);
            }, 1000*123)
            
            let c1q2op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "Both are correct";
                formatOpt(s, 382, 505);
            }, 1000*123.5)
            
            let c1q2op4 = setTimeout(function() {
                q15DrawSB4();
                let s: string = "None of\nthem fits\nthe logic";
                formatOpt(s, 532, 490);
            }, 1000*124)
            ...
            let q18 = setTimeout(function() {
                ...
                t4.draw();
                s25q1.play();
                let s: string = "What strategies can\nbe employed to\ntransform fear before\nyour presentation?";
                formatOpt(s, 106, 80);  
            }, 1000*28.5)
            ...
            let q18op2 = setTimeout(function() {
                q15DrawSB2();
                let s: string = "We should take\nseveral deep\nbreaths from our\ndiaphragm";
                formatOpt(s, 232, 482);
            }, 1000*35.5)
            
            let q18op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "Well, best is\nto be prepared\n& Check out the\narrangements";
                formatOpt(s, 382, 482);
            }, 1000*36)
            ...
            let q19 = setTimeout(function() {
                ...
                t4.draw();
                s25q2.play();
                let s: string = "Which of the following\nis NOT a guideline for\neffective impromptu\nspeaking?";
                formatOpt(s, 106, 80);  
                EllipseClickEvent = false;
            }, 1000*0.5)
            ...
            let q19op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "Also we\nshould draw\nupon personal\nknowledge";
                formatOpt(s, 382, 482);
            }, 1000*8)
            
            let q19op4 = setTimeout(function() {
                q15DrawSB4();
                let s: string = "I think\nwe should\nultimately\nbe brief";
                formatOpt(s, 532, 482);
            }, 1000*8.5)
            ...
            let q22op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "I will not\nvisualise\nanything";
                formatOpt(s, 382, 490);
            }, 1000*7)
            
            let q22op4 = setTimeout(function() {
                q15DrawSB4();
                let s: string = "I will think\nonly about\nour emotions";
                formatOpt(s, 532, 490);
            }, 1000*7.5)
            ...
            let c2q1op1 = setTimeout(function() {
                q15DrawSB1();
                let s: string = "I would quickly\nanswer her query\nas she is my\nfriend";
                formatOpt(s, 82, 482);
            }, 1000*51.4)
            
            let c2q1op2 = setTimeout(function() {
                q15DrawSB2();
                let s: string = "I would thank her\nfor her query first\nand then politely\nanswer her";
                formatOpt(s, 232, 482);
            }, 1000*51.9)
            
            let c2q1op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "I would also\nask others if they\nhave any doubt as\nthere is no point in\nmoving ahead if\nthey do not\nunderstand";
                formatOpt(s, 382, 460);
            }, 1000*52.4)
            ...
            let c2q2op1 = setTimeout(function() {
                q15DrawSB1();
                let s: string = "I will definitely\nclarify as this was\nthe continuation of\nthe previous point";
                formatOpt(s, 82, 482);
            }, 1000*20.5)
            
            let c2q2op2 = setTimeout(function() {
                q15DrawSB2();
                let s: string = "I will show\nher the slides\nto clarify the\npoint";
                formatOpt(s, 232, 482);
            }, 1000*21)
            
            let c2q2op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "This time I will\nexplain and take\nhelp of slide too\nfor better clarity";
                formatOpt(s, 382, 482);
            }, 1000*21.5)
            ...
            let c2q3 = setTimeout(function() {
                drawSQ1();    
                s49q3.play();
                let s: string = "What do you think\nSameeksha should\ndo in this case?";
                formatQue(s, 711, 134);
                EllipseClickEvent = false;
            }, 1000*18)
            ...
            let c2q5 = setTimeout(function() {
                drawSQ1();    
                s49q5.play();
                let s: string = "As she was speaking\nagain, she was asked\nto conclude. Do you\nthink Sameeksha\nhas done justice to\nher presentation? ";
                formatQue(s, 710, 105);
                EllipseClickEvent = false;
            }, 1000*0.5)
            ...
            let c2q5op2 = setTimeout(function() {
                q15DrawSB2();
                let s: string = "No as she did\nnot get a chance\nto complete her\nspeech with all\nthe points";
                formatOpt(s, 232, 474);
            }, 1000*10.5)
            
            let c2q5op3 = setTimeout(function() {
                q15DrawSB3();
                let s: string = "No as she\ncould have told\nthat she will clarify\nthe doubts later\nat the end of\nthe session";
                formatOpt(s, 382, 467);
            }, 1000*11)
    ...
    var Randomcase: number;
    function endScreen(marks: number)  {   //Function for displaying result at each level
        ...
        function buttonhover(e: MouseEvent) {   //Changing the cursor on mouse hover for button
            let x = e.clientX - ract.x;
            let y = e.clientY - ract.y; 
            let p1 = new Geometry.Point(x, y);
    ...
    var squrecontainer: Geometry.Rectangle[] = [];
    
    function rectclick(e: MouseEvent) {   
        let x = e.clientX - ract.x;
        let y = e.clientY - ract.y; 
        let p1 = new Geometry.Point(x, y);  
    ...
    function FinalScreen(marks: number) {   //Function for displaying the final result
        ...
        function buttonhover(e: MouseEvent) {   
            let x = e.clientX - ract.x;
            let y = e.clientY - ract.y; 
            let p1 = new Geometry.Point(x, y);
    ...
    var horImg: boolean = true;
    
    function drawRect(totalImg: number, startp: Geometry.Point, h: number, wi1: number, wi2: number, wi3: number) {
        squrecontainer = [];
    ...
    function q6Ani() {
        ...
        function animate() {   //Function for animation in Q6
            context.clearRect(0, 0, canvas.width, canvas.height);
            x += 0.2;
    ...
    var squrecontainer2: Geometry.Rectangle[] = [];

    function q6Btn() { 
        canvas.addEventListener("click", rectclick2, false);

        function rectclick2(e: MouseEvent) {   
            let x = e.clientX - ract.x;
            let y = e.clientY - ract.y; 
            let p1 = new Geometry.Point(x, y);  
...
function GD(){
    ...
    let level4_score = 0 ;
    let level5_score = 0 ;
    let lvl1 : boolean = false;
    let lvl2 : boolean = false;
    let lvl3 : boolean = false;
    let lvl4 : boolean = false;
    let lvl5 : boolean = false;
    
    let self_anl : boolean = false;
    let score=0;
    ...
    function level4(){
        let theory_num:number;
        context.clearRect(0,0,canvas.width,canvas.height);
        console.warn("You are in level4 .... ");
        canvas.addEventListener("click",mouseclick,false); 
       // let draw1=new Geometry_gd.Bubble_gd(context);
        let flag_theory : number = 0 ;
        normal = false;
        count = 11;
        count_1 = 21;
        score = 0;
    ...
    function display_rightAns1()    //for lvl 1 and 4!!
    {
        context.beginPath();
        context.moveTo(60,300);
        context.lineTo(230,300);
    ...
    function display_rightAns2()    //for lvl 1 and 4!!
    {
        context.beginPath();
        context.moveTo(60,300);
        context.lineTo(230,300);
...
function PI(){
    ...
    let draw2:Geometry_shubham.Box;
    ...
    let lvl2:boolean=false;
    let lvl3:boolean=false;
    let lvl3_1:boolean=false;
    let lvl4:boolean=false;
    let lvl4_img:boolean=false;
    let Result:boolean=false;
    ...
    let users_ans:number[]=[];
    let score2:number=0;
    //img questions data
    let q_s=new Geometry_shubham.Img_Q(context);
    let q1: Geometry_shubham.Img1[]=[];
    ...
    var pt1:Geometry_shubham.Point;
    var pt2:Geometry_shubham.Point;
    var index1:number;
    var index2:number;
    ...
    {
        context.clearRect(0,0,canvas.width,canvas.height);
        let i2:CanvasImageSource=<CanvasImageSource>document.getElementById("host1");
    ...
    function host_Ans(right:boolean)
    {
        context.clearRect(0,0,canvas.width,canvas.height);
        let i2:CanvasImageSource=<CanvasImageSource>document.getElementById("host1");
    ...
    function first_question()
    {
        ...
        context.clearRect(0,0,canvas.width,canvas.height);
        let i1:CanvasImageSource=<CanvasImageSource>document.getElementById("pi1");
    ...
    function lvl2_questions()
    {
        lvl2=true;
        context.clearRect(0,0,canvas.width,canvas.height);  
        let i3:CanvasImageSource=<CanvasImageSource>document.getElementById("s2");
    ...
    function lvl3_start()
    {
        ...
        let i5:CanvasImageSource=<CanvasImageSource>document.getElementById("lady");
        let i=0;
        anim();
        function draw_lady()
        {
    ...
    function case1_theory(count:number)
    {
        context.clearRect(0,0,canvas.width,canvas.height);
        let i1:CanvasImageSource=<CanvasImageSource>document.getElementById("host1");
    ...
    function case2_theory(count:number)
    {
        context.clearRect(0,0,canvas.width,canvas.height);
        let i1:CanvasImageSource=<CanvasImageSource>document.getElementById("host1");
        context.drawImage(i1,250,320,canvas.width-380,canvas.height-300);   
    ...
    function case1_questions()
    {
        ...
        {   //question
            ...
            context.clearRect(0,0,canvas.width,canvas.height);
            let i1:CanvasImageSource=<CanvasImageSource>document.getElementById("lvl3");
            ...
            setTimeout(function(){let i2:CanvasImageSource=<CanvasImageSource>document.getElementById("host1");
            context.drawImage(i2,500,300,canvas.width-550,canvas.height-300);},4*1000);
    ...
    var img41=<CanvasImageSource>document.getElementById("lvl4_1");
    var img42=<CanvasImageSource>document.getElementById("lvl4_2");
    var img43=<CanvasImageSource>document.getElementById("lvl4_3");
    var img44=<CanvasImageSource>document.getElementById("lvl4_4");
