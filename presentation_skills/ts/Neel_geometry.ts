namespace Geometry_gd
{
    export class Point_gd
    {
        public _x:number;
        public _y:number;
    ...
    export class Closepath_gd
    {
        public startpt:Point_gd;
        public point:Point_gd[];
        public context:CanvasRenderingContext2D;
        public color:string;
        
        constructor(context:CanvasRenderingContext2D,arrapoint:Point_gd[],color?:string)
        {
        ...
        draw(str1:string,str2:string,str3:string,str4:string,str5:string,str6:string,str7:string,str8:string)
        {
            var i:number;
    ...
    export class Ellipse_gd extends Closepath_gd
    {
        public a:number;
        public b:number;
        constructor(context:CanvasRenderingContext2D,pt:Point_gd,majorx:number,minory:number,color?:string)
        {
            if(color==undefined)
            super(context,[]);
            else
    ...
    export class Data_gd
    {
        public data:string[][]=[[]];
        public ans : number = 0;
        public aud=new Audio();
        public aud_duration:number;
    ...
    export class Bubble_gd
    {
        private context:CanvasRenderingContext2D;
        private q:Ellipse_gd;
        private qpt:Point_gd;
        private ans : Ellipse_gd;
        private ans_pt :Point_gd;
        private op1:Ellipse_gd;
        private op1pt:Point_gd;
        private op2:Ellipse_gd;
        private op2pt:Point_gd;
        private op3:Ellipse_gd;
        private op3pt:Point_gd;
        private op4:Ellipse_gd;
        private op4pt:Point_gd;
        public str:Data_gd;
        public bubblecontainer:Geometry_gd.Ellipse_gd[]=[];
        ...
        draw(num:number)
        {
            ...
            setTimeout(function(){
                ...
                _this.drawline2();},this.str.aud_duration);
            setTimeout(function(){
                ...
                _this.drawline3();},this.str.aud_duration + 1000);
            setTimeout(function(){
                ...
                _this.drawline4();},this.str.aud_duration + 1500);
            setTimeout(function(){
                ...
                _this.drawline5();},this.str.aud_duration + 2000);    
        }
        drawline1()
        {
            context.beginPath();
    ...
    export class Bubble_gd_level5
    {
        private context:CanvasRenderingContext2D;
        private q:RecteRound_gd;
        private qpt:Point_gd;
        private ans : Ellipse_gd;
        private ans_pt :Point_gd;
        private op1:Ellipse_gd;
    ...
    export class RecteRound_gd {
        private context: CanvasRenderingContext2D;
        private startp: Point_gd;
        private height: number;
        private width: number;
        private csize: number;

        constructor(context: CanvasRenderingContext2D, startp: Point_gd, height: number, width: number, csize: number) {
            this.context = context;
            this.startp = startp;
            this.height = height;
            this.width = width;
        ...
        draw(text : string,text1 : string,text2: string,text3 : string, text4 : string,text5 ?: string,text6 ?: string,text7 ?: string) {
            context.beginPath();
    ...
    export class Button {
        ...
        private color: string = "#E35333";

        constructor(context: CanvasRenderingContext2D, startp: Point_gd, height: number, width: number, arcsize: number) {
            this.context = context;
            this.startp = startp;
            this.height = height;
            this.width = width;
    ...
    export class Img_Container_gd
    {
        public st_pt:Point_gd;
        public width:number;
        public height:number;

        constructor(pt:Point_gd,w:number,h:number)
        {
            this.st_pt=pt;
            this.width=w;
            this.height=h;
    ...
    export class Img_Q_gd
    {
        private context:CanvasRenderingContext2D;
        public img_container:Img_Container_gd[]=[];
        private temp:Img_Container_gd;
        public ans:number[]=[];
        constructor(context: CanvasRenderingContext2D) 
        {
            this.context = context;
